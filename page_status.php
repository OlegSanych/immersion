...
<main id="js-page-content" role="main" class="page-content mt-3">
    ...
    <form action="change_status.php?id=<?php echo $current_user['id']; ?>" method="POST">
        <div class="row">
            <div class="col-xl-6">
