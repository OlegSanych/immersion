                    ...
                    <div class="panel-container">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="full_name" id="simpleinput" class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone_number" id="simpleinput" class="form-control">
                            </div>
                ...
                <div id="panel-1" class="panel">
                    <div class="panel-container">
                        ...
                        <div class="panel-content">
                            ...
                            <!-- Role -->
                            <div class="form-group">
                                <label class="form-label" for="example-select">Выберите прав пользователя</label>
